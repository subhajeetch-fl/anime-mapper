...
├── trending.json             # precomputed, top 50 airing by popularity
├── popular.json              # precomputed, top 50 by MAL members
├── top-rated.json            # precomputed, top 50 by score (min vote count)
├── genre-index.json          # { "Action": [21, 269, ...], ... }
